...
starwars = pd.read_csv("~/My Drive/Red Rock Data Science Conference/2025/RRDS25 (GitHub)/Data/starwars.csv")
...
plot_d.show() # Type plot_d or plot_d.show()
...
# This put the x-axis and the y-axis on the plot. The y-axis contains the
#   mass info.
...
# This creates the scatter plot! The x and y axes are set up and points were 
#   added to the plot.
...
plot_h.show() # Type plot_h or plot_h.show()
...
plot_i.show() # Type plot_i or plot_i.show()
...
plot_j = (
  ggplot(starwars2, aes(x = "height", y = "mass"))
  + geom_point()
  + labs(x = "Height (cm)", y = "Mass (kg)") # Change the x and y axis labels
)
plot_j.show() # Type plot_j or plot_j.show()
...
plot_k = (
  ...
  + labs(x = "Height (cm)", y = "Mass (kg)",
         title = "Scatterplot of Mass vs Height for Star Wars Characters") 
)
plot_k.show()
...
plot_l.show() # Type plot_l or plot_l.show()
...
#   se = False. Feel free to change the color of the line as well. Call this
#   plot_m instead of plot_l. 
plot_m = (
  ggplot(starwars2, aes(x = "height", y = "mass"))
  + geom_point()
  + labs(x = "Height (cm)", 

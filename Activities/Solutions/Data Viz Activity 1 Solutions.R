...
# Part b
# ======
# We are going to use the starwars data set that was loaded with the tidyverse.
...
#   frame as starwars2. Remember you can remove a point by using brackets []
#   and putting a negative number in there.
